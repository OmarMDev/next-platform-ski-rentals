...
export default async function CreateRentalPage() {
        ...
        <div className="max-w-md w-full">
          <div className="bg-amber-50 border border-amber-200 p-8 rounded-[32px] text-center">
            ...
            <p className="text-gray-600 mb-4">
              ...
              Your current role is: <strong className="text-amber-700">{profile.role}</strong>
            </p>
  ...
  return (
    <div className="py-8">
      <div className="mb-8">
        <Link href="/" className="text-[#7C9C95] hover:text-[#6a8a83] font-medium transition-colors">
          ← Back to Listings
        </Link>
      </div>
      
      <div className="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">List Your Gear</h1>
